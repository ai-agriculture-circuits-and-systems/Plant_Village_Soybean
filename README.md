...
Soybean leaf classification dataset from Plant Village. Contains images of healthy soybean leaves. This dataset follows the standardized layout specification.
...
│   ├── soybeans_instances_train.json
│   ├── soybeans_instances_val.json
│   └── soybeans_instances_test.json
├── scripts/
...
- Splits: `soybeans/sets/*.txt` list image basenames (no extension). If missing, all images are used.
...
<table>
  ...
  <tr>
    ...
    <td>
      <img src="soybeans/healthy/images/sample.jpg" alt="healthy" width="260"/>
      <div align="center"><code>soybeans/healthy/images/sample.jpg</code></div>
    </td>
  </tr>
</table>
