#!/usr/bin/env python3
"""
Convert soybeans dataset annotations to COCO JSON format.
...
def main():
    parser = argparse.ArgumentParser(description="Convert soybeans annotations to COCO JSON")
    parser.add_argument(
        "--root",
        type=Path,
